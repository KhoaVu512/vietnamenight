...
function Footer() {
  return (
    <div className="w-full flex ">
      <div className="flex w-[1214px]">
        <div className="flex flex-col w-[416px] h-[1px] mt-5 px-[18px]">
          ...
          <div className="mt-3">
            <div className="text-[13px] my-1">
              ...
              <div className="flex w-[235px] justify-between mt-[6px]">
                <div className="hover:text-[#888] cursor-pointer">Su kien</div>
                <div className="hover:text-[#888] cursor-pointer">
              ...
              <div>
                <div className="hover:text-[#888] cursor-pointer">Lien he</div>
              </div>
            </div>
          </div>
        </div>
