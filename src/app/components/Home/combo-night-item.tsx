...
function ComboNightItem() {
  return (
    <Link
      href={'#'}
      className="relative w-[383px] h-[288px] mt-20 border-[1px] max-md:w-[252px] max-md:h-[190px] mx-2"
    >
      <div className="text-[18px] font-bold  hover:text-red-400">
        <img
          ...
          alt="img-location"
          className=" flex justify-center rounded-xl h-full  flex-order-2 w-full"
        />
